...
Visit the app [web page](/qahiri/app/english) and type Arabic in the text area. Next to the text, the alternates of the character before the text cursor will appear (the gray bar). Clicking on an alternate will cause it to be used instead of the current form:

{{ picture('/assets/images/qahiri/screenshot', 'Screen shot of the app', 'png') }}
...
{{ picture('/assets/images/qahiri/screenshot-dotless', 'Screenshot with no dots', 'png') }}
...
{{ picture('/assets/images/qahiri/screenshot-rounded-dots', 'Screenshot with rounded dots', 'png') }}
...
{{ picture('/assets/images/qahiri/screenshot-spacing', 'Screenshot showing spacing', 'png') }}
...
{{ picture('/assets/images/qahiri/screenshot-clash', 'Screenshot showing clashing letters', 'png') }}
