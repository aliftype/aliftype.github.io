...
Visit the app [web page](./app/english) and type Arabic in the text area. Next to the text, the alternates of the character before the text cursor will appear (the gray bar). Clicking on an alternate will cause it to be used instead of the current form:

{% include picture src='/assets/images/qahiri/screenshot' ext='png' alt='Screen shot of the app' %}
...
{% include picture src='/assets/images/qahiri/screenshot-dotless' ext='png' alt='Screenshot with no dots' %}
...
{% include picture src='/assets/images/qahiri/screenshot-rounded-dots' ext='png' alt='Screenshot with rounded dots' %}
...
{% include picture src='/assets/images/qahiri/screenshot-spacing' ext='png' alt='Screenshot showing spacing' %}
...
{% include picture src='/assets/images/qahiri/screenshot-clash' ext='png' alt='Screenshot showing clashing letters' %}
