...
يمكن استخدام التطبيق من بزيارة [صفحته](./app) والكتابة في المنطقة المخصصة للكتابة. ستظهر بجوار النص التنويعات المتاحة للحرف الذي يسبق مؤشر النص (المستطيل الرمادي). النقر على أي تنويعة سيستخدمها بدل الشكل الحالي للحرف:

{% include picture src='/assets/images/qahiri/screenshot' ext='png' alt='لقطة شاشة للتطبيق في الوضع المبدئي' %}
...
{% include picture src='/assets/images/qahiri/screenshot-dotless' ext='png' alt='لقطة شاشة للتطبيق بدون نقاط' %}
...
{% include picture src='/assets/images/qahiri/screenshot-rounded-dots' ext='png' alt='لقطة شاشة للتطبيق بنقاط مستديرة' %}
...
{% include picture src='/assets/images/qahiri/screenshot-spacing' ext='png' alt='لقطة شاشة توضح المسافات بين الحروف' %}
...
{% include picture src='/assets/images/qahiri/screenshot-clash' ext='png' alt='لقطة شاشة يظهر فيها تداخل بعض الحروف' %}
