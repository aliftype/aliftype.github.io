...
يمكن استخدام التطبيق من بزيارة [صفحته](/qahiri/app/) والكتابة في المنطقة المخصصة للكتابة. ستظهر بجوار النص التنويعات المتاحة للحرف الذي يسبق مؤشر النص (المستطيل الرمادي). النقر على أي تنويعة سيستخدمها بدل الشكل الحالي للحرف:

{{ picture('/assets/images/qahiri/screenshot', 'لقطة شاشة للتطبيق في الوضع المبدئي', 'png') }}
...
{{ picture('/assets/images/qahiri/screenshot-dotless', 'لقطة شاشة للتطبيق بدون نقاط', 'png') }}
...
{{ picture('/assets/images/qahiri/screenshot-rounded-dots', 'لقطة شاشة للتطبيق بنقاط مستديرة', 'png') }}
...
{{ picture('/assets/images/qahiri/screenshot-spacing', 'لقطة شاشة توضح المسافات بين الحروف', 'png') }}
...
{{ picture('/assets/images/qahiri/screenshot-clash', 'لقطة شاشة يظهر فيها تداخل بعض الحروف', 'png') }}
