...
يتيح التطبيق تصدير ملف SVG للنص المكتوب يمكن تعديله في أي من تطبيقات الرسوم المتجهية. الضغط على زر ![التصدير](/assets/images/app/export.svg){:.زر} سينزّل الملف.

يمكن حفظ النص الحالي وكل التنويعات المختارة بضغط زر ![الحفظ](/assets/images/app/save.svg){:.زر}، ويمكن تحميل النص مرة أخرى بضغط زر ![الفتح](/assets/images/app/open.svg){:.زر}.

ضغط زر ![المسح](/assets/images/app/clear.svg){:.زر} سيمسح كل النص المكتوب.
